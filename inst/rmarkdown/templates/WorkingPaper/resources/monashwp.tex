...
\makeatother
\ExecuteBibliographyOptions{bibencoding=utf8,minnames=1,maxnames=3, maxbibnames=99,dashed=false,terseinits=true,giveninits=true,uniquename=false,uniquelist=false,labeldate=true,doi=false, isbn=false,url=true}
...
$author.address$\newline
$if(author.email)${Email: $author.email$\newline}$else$$endif$$if(author.correspondingauthor)$Corresponding author$endif$\\[1cm]
$endfor$
}$endif$
